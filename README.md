...
INSERT INTO `pogo`.`move` (`type`, `name`, `power`, `pokemon_id`, `variant`) VALUES ('poison', 'Cross Poison', '40', '890-eternamax-eternatus', 'CHARGED');
...
INSERT INTO `pogo`.`move` (`type`, `name`, `power`, `pokemon_id`, `variant`) VALUES ('dragon', 'Dynamax Cannon', '215', '890-eternamax-eternatus', 'CHARGED');

-- Eternatus - Dynamax
INSERT INTO `pogo`.`max_move` (`type`, `name`, `power`, `pokemon_id`) VALUES ('dragon', 'Dynamax Cannon', '450', '890');
UPDATE `pogo`.`pokemon` SET `max_available` = true WHERE (`pokemon_id` = '890');
