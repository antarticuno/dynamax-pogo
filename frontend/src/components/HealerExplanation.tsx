...
export default function HealerExplanation() {
  return <StyledContainer>
    ...
    <p>Comparisons can be made between Max Guard and Max Spirit as both fulfill supportive roles during max battles. Their differences are made even more clear when considering the healing percentages per level of Max Spirit:
      <table>
        <thead>
          <tr>
            <th>Level</th>
