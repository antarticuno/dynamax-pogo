...
export default function AttackerExplanation() {
  return <StyledContainer>
    ...
    <p>Most often, the Pokemon you'll want to specialize into an attacker role won't have a lot of defensive stats as well to lean on - this means that some of the best attackers like Inteleon and Gengar will not survive more than a hit or two from a Dynamax boss. Instead, focus on switching into your attacker Pokemon when the coast is clear. Some of these scenarios include:</p>
    <ul>
